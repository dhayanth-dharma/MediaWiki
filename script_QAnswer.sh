...
#echo "Uploading ..."
#curl -X POST 'https://qanswer-core1.univ-st-etienne.fr/api/dataset/upload?dataset=disabilitywiki' -H "Authorization: Bearer $token" -F file=@dump.nt
echo "Updating"
curl -X POST 'https://qanswer-core1.univ-st-etienne.fr/api/dataset/edit?dataset=disabilitywiki' -H "Authorization: Bearer $token" -F file=@dump.nt
echo "Indexing ..."
curl -X POST 'https://qanswer-core1.univ-st-etienne.fr/api/dataset/index' -F 'dataset=disabilitywiki' -F 'properties=http://purl.org/dc/elements/1.1/title,https://schema.org/name,http://www.w3.org/2004/02/skos/core#prefLabel,http://www.w3.org/2004/02/skos/core#altLabel,http://www.w3.org/2000/01/rdf-schema#label,http://www.wikidata.org/prop/direct/P1549,http://purl.org/dc/terms/identifier,http://purl.org/dc/terms/title,https://linkedopendata.eu/prop/direct/P150' -F 'type=https://linkedopendata.eu/prop/direct/P35' -F 'subclass=https://linkedopendata.eu/prop/direct/P302' -H "Authorization: Bearer $token"
